...
parser.add_argument('--src_dir', default=r'E:\image_denoising\zzz-finished\DRNet\DRNet\DR_new\trainsets\Data', type=str, help='Directory for full resolution images')
parser.add_argument('--tar_dir', default='../SIDD_patches/train',type=str, help='Directory for image patches')
parser.add_argument('--ps'
                    , default=256, type=int, help='Image Patch Size')
